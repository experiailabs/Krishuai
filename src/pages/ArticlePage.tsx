                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {article.slug && (
                      <>
                        {/* LinkedIn share */}
                        <motion.a
                          href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(`https://krishuaitech-murffryc.manus.space/insights/${article.slug}`)}`}
                          target="_blank"
                          rel="noopener noreferrer"
                          aria-label="Share on LinkedIn"
                          onClick={(e) => e.stopPropagation()}
                          title="Share on LinkedIn"
                          className="relative w-7 h-7 rounded-lg flex items-center justify-center border border-white/10 text-white/30 transition-colors duration-200"
                          style={{ flexShrink: 0 }}
                          whileHover={{
                            scale: 1.18,
                            color: "#0A66C2",
                            ...
                            boxShadow: "0 0 10px rgba(10,102,194,0.35), 0 0 20px rgba(10,102,194,0.15)",
                          }}
                          whileTap={{ scale: 0.92 }}
                        ...
                        {/* Twitter/X share */}
                        <motion.a
                          href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(article.title)}&url=${encodeURIComponent(`https://krishuaitech-murffryc.manus.space/insights/${article.slug}`)}`}
                          target="_blank"
                          rel="noopener noreferrer"
                          ...
                          whileHover={{
                            scale: 1.18,
                            color: "#e7e9ea",
                            borderColor: "rgba(231,233,234,0.35)",
                            backgroundColor: "rgba(231,233,234,0.08)",
                            boxShadow: "0 0 10px rgba(231,233,234,0.2), 0 0 20px rgba(231,233,234,0.08)",
                          }}
                          whileTap={{ scale: 0.92 }}
                          transition={{ type: "spring", stiffness: 450, damping: 18 }}
                        >
